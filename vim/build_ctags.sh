set -x
ctags -R -f ~/.vim/tags/cubit.tags --c++-kinds=+pl --fields=+iaS --extra=+q /usr/local/ATD/cubit/cubit
ctags -R -f ~/.vim/tags/kaboodle.tags --c++-kinds=+pl --fields=+iaS --extra=+q /usr/local/ATD/kaboodle/kaboodle
ctags -R -f ~/.vim/tags/qbus.tags --c++-kinds=+pl --fields=+iaS --extra=+q /home/nsmith/projects/qbus
